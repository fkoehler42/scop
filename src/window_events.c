...
/*   Updated: 2018/06/28 18:36:18 by fkoehler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		key_callback(GLFWwindow* win, int key, int scanc, int action, int mods)
{
	...
	if (key == GLFW_KEY_PAGE_DOWN)
		matrices->rotate = mat4_rotate(matrices->rotate, -0.04f, Z_AXIS);
	// if (key == GLFW_KEY_A)
	// 	matrices->view = mat4_translate(matrices->view, new_vec3(-1.2f, 0, 0));
	// if (key == GLFW_KEY_D)
	// 	matrices->view = mat4_translate(matrices->view, new_vec3(1.2f, 0, 0));
	// if (key == GLFW_KEY_W)
	// 	matrices->view = mat4_translate(matrices->view, new_vec3(0, 1.2f, 0));
	// if (key == GLFW_KEY_S)
	// 	matrices->view = mat4_translate(matrices->view, new_vec3(0, -1.2f, 0));
	// if (key == GLFW_KEY_Q)
	// 	matrices->view = mat4_translate(matrices->view, new_vec3(0, 0, 1.2f));
	// if (key == GLFW_KEY_E)
	// 	matrices->view = mat4_translate(matrices->view, new_vec3(0, 0, -1.2f));
	mvp_update(matrices);
